...
Declare_Any_Class( "Bee_Scene",  // An example of drawing a hierarchical object using a "model_transform" matrix and post-multiplication.
                  ...
                  {this.globals = context.globals;
                   ...
                   var shapes = { 'ball' : new Grid_Sphere(20,20),
                  ...
                  'wing'     : new wing(),
                  'tail'     : new tail(),
                  'tree'      :new Shape_From_File("n64tree.obj"),
                  'grass'    :new Shape_From_File("kusamura.obj"),
                  'grass2'   :new Shape_From_File("grass.obj"),
                  'bob'      :new Shape_From_File("spongebob.obj"),
                  'dog'      :new Shape_From_File("dog.obj"),
                'cylinder' : new Capped_Cylinder(4,12)};
                  var temp=document.getElementById("audio1");
                  temp.playbackRate = 1;
                  temp.play();
                  this.submit_shapes( context, shapes );
                  ...
                  this.define_data_members(
                                           ...
                                           tree: context.shaders_in_use["Phong_Model"].material( Color(.5,.5,.5,1 ), .5, .5, .5, 40,context.textures_in_use["m64_tree.png"]),
                                           grass: context.shaders_in_use["Phong_Model"].material( Color(0,1,0,.5 ), .5, .5, .5, 40, context.textures_in_use["kusamura.png"]),
                                           green  : context.shaders_in_use["Phong_Model" ].material( Color( 0,1,.5, 1 ), .4, .8, .4, 20 ),
                                           forest: context.shaders_in_use["Phong_Model"].material( Color(.5,.5,.5,1 ), .5, .5, .5, 40,context.textures_in_use["forest.png"]),
                                           grassland: context.shaders_in_use["Phong_Model"].material( Color(.5,.5,.5,1 ), .5, .5, .5, 40,context.textures_in_use["grassland.png"]),
                                           dog: context.shaders_in_use["Phong_Model"].material( Color(.5,.5,.5,1 ), .5, .5, .5, 40,context.textures_in_use["doggy.png"]),
                                           wingcolor: context.shaders_in_use["Phong_Model"].material( Color( .5,.5,.5,1 ), .5, .5, .5, 40, context.textures_in_use["wingcolor.png"] ),
                  ...
                  'draw_bird'(model_transform,graphics_state)
                  {
                  
                  model_transform = mult(model_transform, translation(0,9,0));
                  model_transform = mult(model_transform, scale (.3,.3,.3));
                  model_transform = mult(model_transform, translation(0,-32,0));

                  //head
                  
                  model_transform = mult(model_transform, scale(2, 1, 1));
                  model_transform = mult(model_transform, translation(0, 2, -3));
                  this.shapes.ball.draw(graphics_state, model_transform, this.orangePlastic);
                  
                  //wing
                  this.draw_LeftWing(model_transform,graphics_state);
                  this.draw_RightWing(model_transform,graphics_state);
                  ...
                  'draw_LeftWing'(model_transform,graphics_state)
                  {
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation(.5,.5,-.5));
                  model_transform = mult(model_transform,rotation(50*Math.sin(5*t),[1,0,0]));
                 // model_transform = mult(model_transform, scale(2,.05,.3));
                  model_transform = mult(model_transform, translation(0,-.45,.5));
                  model_transform = mult(model_transform, rotation(90,0,1,0));
                  model_transform = mult(model_transform, rotation(90,1,0,0));
                  this.shapes.wing.draw(graphics_state, model_transform, this.wingcolor);
                 
                  },
                  
                  'draw_RightWing'(model_transform,graphics_state)
                  {
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation(.5,0.5,-.5));
                  model_transform = mult(model_transform,rotation(50*Math.sin(-5*t),[1,0,0]));
                  model_transform = mult(model_transform, translation(0,-1,0));
                  model_transform = mult(model_transform, scale(1,-1,1));
                  model_transform = mult(model_transform, translation(.1,-.55,.5));
                  model_transform = mult(model_transform, rotation(90,0,1,0));
                  model_transform = mult(model_transform, rotation(90,1,0,0));
                  ...
                  {
                  model_transform = mult(model_transform, translation(0,.5,-8));
                  model_transform = mult(model_transform, rotation(30,1,0,0));
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation(.5,.5,-.5));
                  model_transform = mult(model_transform,rotation(10*Math.sin(5*t),[0,1,0]));
                  model_transform = mult(model_transform, rotation(90,0,0,1));
                  model_transform = mult(model_transform, rotation(90,0,1,0));
                  model_transform = mult(model_transform, scale(3, 3, 5));
                  this.shapes.tail.draw(graphics_state, model_transform, this.blueGlass);
                  model_transform = mult(model_transform, rotation(180,1,0,0));
                  this.shapes.tail.draw(graphics_state, model_transform, this.blueGlass);

                  },
                  
                  'draw_plane'(model_transform,graphics_state)
                  {
                       var model_transform = identity();
                       model_transform =mult (model_transform, translation(0,-10,0));
                       model_transform = mult(model_transform, scale (40,1,20));
                  ...
                  model_transform = mult(model_transform, scale (40,20,.1));
                  this.shapes.box.draw(graphics_state, model_transform, this.forest);
                  model_transform = mult(model_transform, scale (.025,.05,10));
                  model_transform =mult (model_transform, translation(0,0,15));
                  
                  model_transform = mult(model_transform, scale (.1,20,20));
                  model_transform =mult (model_transform, translation(-300,0,0));
                  this.shapes.box.draw(graphics_state, model_transform, this.forest);
                  model_transform = mult(model_transform, scale (10,.05,.05));
                  model_transform =mult (model_transform, translation(300,0,0));
                  
                  model_transform = mult(model_transform, scale (10,125,125));
                  model_transform =mult (model_transform, translation(5,0,-1.2));
                  this.shapes.box.draw(graphics_state, model_transform, this.forest);
                  model_transform =mult (model_transform, translation(-5,0,1.2));
                  model_transform = mult(model_transform, scale (.1,.008,.008));
                  
                  model_transform = mult(model_transform, scale (200,1,200));
                  model_transform =mult (model_transform, translation(1,100,-1.5));
                  this.shapes.box.draw(graphics_state, model_transform, this.forest);
                  ...
                  'draw_forest'(model_transform,graphics_state)
                  {
                  ...
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));
                  ...
                  this.shapes.grass2.draw(graphics_state, model_transform, this.grass);
                  
                  var model_transform = identity();
                  model_transform = mult(model_transform, translation (7,-7,-2));
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));
                 ...
                 var model_transform = identity();
                  model_transform = mult(model_transform, translation (-5,-7,2));
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation (1,-.5,-3));
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));
                  model_transform = mult(model_transform, scale (.6,1,1));
                  this.shapes.grass2.draw(graphics_state, model_transform, this.grass);
                  ...
                  var model_transform = identity();
                  model_transform = mult(model_transform, translation (-8,-7,-4));
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation (1,-.5,-3));
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));
                  model_transform = mult(model_transform, scale (.6,1,1));
                  ...
                  var model_transform = identity();
                  model_transform = mult(model_transform, translation (-12,-7,-1));
                  t = graphics_state.animation_time/500;
                  model_transform = mult(model_transform, translation (1,-.5,-3));
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));
                  model_transform = mult(model_transform, scale (.6,1,1));
                  ...
                  {
                  model_transform = mult(model_transform, translation(4,6,0));
                  model_transform = mult(model_transform, translation (-4,-5,0));
                  model_transform = mult(model_transform, scale (.5,.5,.5));
                  this.shapes.ball.draw(graphics_state, model_transform,this.orangePlastic);
                  
                  
                  model_transform = mult(model_transform, translation (0,-2.4,0));
                  model_transform = mult(model_transform, scale (.7,1.4,.7));
                  this.shapes.box.draw(graphics_state, model_transform,this.stars);
                  
                  model_transform = mult(model_transform, translation (-1.5,-.1,0));
                  model_transform = mult(model_transform, scale (.3,1,.3));
                  this.shapes.box.draw(graphics_state, model_transform,this.orangePlastic);
                  ...
                  model_transform = mult(model_transform, translation (0,.5,0));
                  model_transform = mult(model_transform, scale (.1,1,.15));
                  t = graphics_state.animation_time/500;
                  //model_transform = mult(model_transform, translation (1,-.5,-3));
                  model_transform = mult(model_transform,rotation(-5*Math.sin(-2*t),[1,0,0]));

                  
                  model_transform = mult(model_transform, translation (-3,-2,0));
                  this.shapes.box.draw(graphics_state, model_transform,this.orangePlastic);
                  ...
                  'draw_dog'(model_transform,graphics_state)
                  {
                    model_transform = mult(model_transform, translation (0,0,0));
                    this.shapes.dog.draw(graphics_state, model_transform,this.dog);
                  ...
                  controls.add("j",this,function(){updir = 1;});
                  controls.add("j",this,function(){updir = 0;},{'type':'keyup'});
                  controls.add("l",this,function(){downdir = 1;});
                  controls.add("l",this,function(){downdir = 0;},{'type':'keyup'});
                  
                  controls.add("5",this, function(){fordire = 1;});
                  controls.add("5",this,function(){fordire = 0;},{'type':'keyup'});
                  controls.add("6",this, function(){backdire = 1;} );
                  controls.add("6",this,function(){backdire = 0;},{'type':'keyup'});
                  controls.add("7",this, function(){leftdire=1;});
                  controls.add("7",this,function(){leftdire=0;},{'type':'keyup'});
                  controls.add("8",this, function(){rightdire=1;});
                  controls.add("8",this,function(){rightdire=0;},{'type':'keyup'});
                  ...
                  var seconds = Math.floor( this.globals.graphics_state.animation_time/1000);
                  if(seconds > temp_time)
                  {
                  fps = (this.tick - temp_f);
                  temp_time = seconds;
                  temp_f = this.tick;
                  }
                  ...
                  graphics_state.lights = [ new Light( vec4(  30,  30,  34, 1 ), Color( 0, .4, 0, 1 ), 100000 ),
                   ...
                   var model_transform = identity();
                   var bird_t = graphics_state.animation_time/1000;
                   var bird_rotate  = mult(model_transform, rotation(bird_t*180/3.14, [0,1,0]));
                  

                   bird_x =5*Math.sin(bird_t);
                   bird_y =3+.2*Math.sin(3*bird_t);
                    bird_z =5*Math.cos(bird_t);
                    var bird_revolve = mult(model_transform, translation(bird_x, bird_y, bird_z));
                    this.draw_bird(mult(mult(model_transform, bird_revolve), bird_rotate),graphics_state);
                  
                  
                  
                  //this.shapes.ball.draw(graphics_state, mult(identity(), translation(bird_x, bird_y,bird_z)), this.bluePlastic);
                 
                  
                  var model_transform = identity();
                  var t = graphics_state.animation_time/1000,
                  orbit = mult(rotation(t/4000,2*Math.cos(t),1, 2*Math.sin(t)),translation(.5,Math.sin(5*t),0));
                  var tilt_spin = rotation( 80 * t, [.1,.8,.1 ]);
                  var x = mult(orbit, tilt_spin);
                  model_transform = mult(model_transform, scale (.5,.5,.5));
                  ...
                  this.draw_plane(model_transform, graphics_state);
                  this.draw_background(model_transform, graphics_state);
                  this.draw_forest(model_transform, graphics_state);
                  ...
                  model_transform = translation(person_x,person_y,person_z);
                  ...
                  var counters = life;
                  document.getElementById("counter").innerHTML = "Health point: " + counters;
                  
                  
                  
                  
                  model_transform = translation(dog_x,dog_y,dog_z);
                  this.draw_dog(model_transform, graphics_state);

                  
                  var model_transform = identity();
                  var t = graphics_state.animation_time/1000;
                  graphics_state.camera_transform = lookAt([12*Math.cos(t/2),9,20*(Math.sin(t/2))+10],[0,-1.5,0],[0,1,0]);
                  
                  if(t>=3.141592635)
                  {
                      graphics_state.camera_transform = lookAt([-5,3,26],[person_x,person_y,person_z],[0,1,0]);
                  
                  }
                  
                  
                  if(Math.abs(person_x-dog_x)<=1 && Math.abs(person_z-dog_z)<=1)
                  {
                  life = life -1;
                  }
                  
                 if(Math.abs(person_x-bird_x)<=1.3 && Math.abs(bird_y-person_y)<=1.3 && Math.abs(person_z-bird_z)<=1.3)
                  {
                  graphics_state.camera_transform = lookAt([bird_x,2,0],[1,.5,-.5],[0,1,0]);
                  life = life +1;
                  }
                 
                  if(life <=0)
                  {
                    graphics_state.camera_transform = lookAt([-3,1,0],[1,.5,-10],[0,1,0]);
                    model_transform = mult(model_transform, scale(20,10,10));
                    this.shapes.box.draw(graphics_state, model_transform,this.orangePlastic);
                  }
